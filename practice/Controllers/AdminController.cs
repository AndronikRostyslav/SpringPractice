    ...
    namespace practice.Controllers
    {
        ...
        /// <returns>
        /// Returns NoContent if the deletion is successful. Returns Unauthorized if the user is not logged in, Conflict if the user does not have access rights, and NotFound if the user is not found.
        /// </returns>
        ...
        // Додатковий метод для управління квитками

        /// <summary>
        /// Cancels a booked ticket by ID.
        /// </summary>
        /// <param name="id">The ID of the ticket to cancel.</param>
        /// <returns>
        /// Returns NoContent if the cancellation is successful. Returns NotFound if the ticket is not found.
        /// </returns>
